    ...
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
            ...
            <a type="button" href="/sesi/logout"
                class="text-white bg-[#00A671] hover:bg-[#00744F] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center ">
                Log out
            </a>
            @else
        ...
        <div class="navbar-custom items-center justify-between hidden w-full md:flex md:w-auto md:order-1"
            ...
            <ul
                ...
                <li>
                    <a href="{{url('home')}}"
                        class=" block py-2 px-3 text-gray-900 rounded md:bg-gary-100 md:hover:bg-transparent md:hover:text-[#00A671] md:p-0 md:">Home</a>
                </li>
