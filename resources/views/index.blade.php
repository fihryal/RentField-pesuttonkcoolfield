...
<section class="border h-fit bg-[#00A671]  flex justify-center items-start">
    ...
    <div class="block justify-center items-center">
        ...
        <h1 class="text-xl text-white mt-12 pr-32 pl-32  sm:text-3xl  text-center">
            ...
            yang ramah, kami menyediakan pengalaman olahraga yang menyenangkan untuk semua pecinta olahraga.Dengan
            lapangan berkualitas tinggi dan staf yang siap membantu, Pesut Tonk Cool Field adalah pilihan terbaik untuk
            latihan, turnamen, atau acara khusus Anda.Bergabunglah dengan kami di Pesut Tonk Cool Field dan rasakan
            kesenangan berolahraga bersama kami!
        </h1>
